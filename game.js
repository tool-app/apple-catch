...
fruitImg.src = "https://toppng.com/uploads/preview/apple-fruit-png-apple-fruit-transparent-11563073201mj52xnr1gp.png";
...
// game functions
function spawnFruit() {
  var fruitWidth = 40 + Math.random() * 20;
  var fruitHeight = 40 + Math.random() * 20;
...
function update() {
  ...
  for (var i = 0; i < fruits.length; i++) {
    context.drawImage(fruits[i].img, fruits[i].x, fruits[i].y, fruits[i].width, fruits[i].height);
  }
